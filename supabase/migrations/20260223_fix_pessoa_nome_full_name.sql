-- Fix pessoa_nome to include sobrenome (nome completo) in view_cards_acoes
-- Anteriormente: pe.nome AS pessoa_nome (apenas primeiro nome)
-- Agora: TRIM(pe.nome || ' ' || pe.sobrenome) AS pessoa_nome (nome completo)

...
-- Busca duplicados de contato em tempo real durante criação/edição
-- Usa as mesmas funções de normalização dos GENERATED columns (normalize_cpf, normalize_phone_brazil)
-- =============================================================================
...
BEGIN
    -- Normaliza inputs usando as MESMAS funções dos GENERATED columns
...
-- Grant para acesso via anon key (RLS)

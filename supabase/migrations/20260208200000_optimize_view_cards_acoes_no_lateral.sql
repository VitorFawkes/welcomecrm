-- ============================================================================
-- MIGRATION: Optimize view_cards_acoes - Replace LATERAL JOINs with pre-aggregated subqueries
-- Problem: LATERAL JOINs execute per-row (730+ cards × 3 subqueries = timeout)
-- Solution: Pre-aggregate tarefas/activities once, then JOIN (single scan per table)
-- Date: 2026-02-08
-- ============================================================================
...
-- ============================================================================
-- 2. RECREATE view_cards_acoes with pre-aggregated JOINs (NO LATERAL)
-- ============================================================================
...
-- ============================================================================
-- 4. RECREATE view_archived_cards
-- ============================================================================

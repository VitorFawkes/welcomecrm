-- ============================================================================
-- MIGRATION: Add Contact Info to Cards View
-- Description: Adds email and phone from contatos to view_cards_acoes for search
-- Date: 2026-02-02
-- Priority: P1
-- ============================================================================
...
SELECT 
    ...
    -- NEW GROUP COLUMNS (Kept from previous migration)
    c.parent_card_id,
    c.is_group_parent,
    c.group_capacity,

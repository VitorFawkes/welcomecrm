-- 1. Ensure view_agenda filters out completed and deleted tasks
-- This view is the source of truth for "Agenda" items.
...
-- 2. Update view_cards_acoes to use the stricter view_agenda
-- This ensures proxima_tarefa is NULL if no pending items exist.

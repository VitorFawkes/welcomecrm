...
-- 2. Create Enum (Skipped, using existing)
-- Existing values: admin, gestor, sdr, vendas, pos_venda, concierge, financeiro
...
UPDATE public.profiles SET role_new = 'sdr'::public.app_role WHERE role = 'sdr';
-- Map 'planner' to 'pos_venda' if it exists in text
UPDATE public.profiles SET role_new = 'pos_venda'::public.app_role WHERE role = 'planner';
-- Default others

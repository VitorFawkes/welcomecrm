-- FIX: Update view_cards_acoes to use view_agenda
-- This ensures the CRM Header (Next Step, Badges) works with the new Task Module.
...
SELECT
    ...
    -- PROXIMA TAREFA (UPDATED to use view_agenda)

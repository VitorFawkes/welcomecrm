-- Restore is_group_parent and parent_card_id to view_cards_acoes
-- These were accidentally dropped in the previous migration, breaking Group/Linked card filtering.
-- Uses CASCADE to handle dependencies (view_dashboard_funil)

-- 1. Drop the base view and all dependents
DROP VIEW IF EXISTS view_cards_acoes CASCADE;

-- 2. Recreate view_cards_acoes with ALL required columns

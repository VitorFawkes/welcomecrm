...
export function WhatsAppGovernanceTab() {
    ...
    if (isLoadingConfig) {
        return <div className="p-4 text-muted-foreground">Carregando configurações...</div>;
    }
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Configure o comportamento automático para mensagens e leads.
                    </p>
                </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2 duration-300">
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    options={pipelines?.map((p: any) => ({ value: p.id, label: p.nome })) || []}
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    options={stages?.map((s: any) => ({ value: s.id, label: s.nome })) || []}
